...
import darkLogo from '@public/images/Logo/Ashavid-logo-files-15.png';
            ...
            <RevealAnimation delay={0.3}>
              <div className="max-w-[306px]">
                ...
                <p className="text-accent/60 text-tagline-1 mt-4 mb-7 font-normal">
                  Ashavid helps immigrant founders turn their ideas into real, operating businesses in Canada through mentorship, field visits, and honest readiness assessments.
                </p>
          ...
          <div className="col-span-12 grid grid-cols-12 gap-x-0 gap-y-8 xl:col-span-8">
              ...
              <RevealAnimation delay={0.4}>
                <div className="space-y-8">
                  ...
                  <ul className="space-y-3 sm:space-y-5">
                    ...
                    <li>
                      <Link href="/launchpad" className="footer-link">
                        Launchpad Program
                      </Link>
                    </li>
                    <li>
            ...
            <div className="col-span-12 md:col-span-4">
              <RevealAnimation delay={0.5}>
                <div className="space-y-8">
                  <p className="sm:text-heading-6 text-tagline-1 text-primary-50 font-normal">Programs</p>
                  <ul className="space-y-3 sm:space-y-5">
                    <li>
                    ...
                    <li>
                      <Link href="/immigrants" className="footer-link">
                        For Immigrants
                      </Link>
                    </li>
                    <li>
                      <Link href="/businesses" className="footer-link">
                        For SMEs
                      </Link>
                    </li>
                    <li>
        ...
        <div className="relative pt-[26px] pb-[100px] text-center">
          ...
          <RevealAnimation delay={0.7} offset={10} start="top 105%">
            <p className="text-tagline-1 text-primary-50 font-normal">
              © {new Date().getFullYear()} Ashavid – Empowering immigrant founders to build real ventures in Canada.
            </p>
          </RevealAnimation>
        </div>
      </div>
